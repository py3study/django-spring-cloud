...
def server(request):
    ...
    server_dict = {
        "config": {
            "ip": "svc-config.default.svc.cluster.local",
            "port": 8002,
        },
        "auth": {
            "ip": "svc-auth.default.svc.cluster.local",
            "port": 8003,
        },
        "user": {
            "ip": "svc-user.default.svc.cluster.local",
            "port": 8004,
        },
        "gateway": {
            "ip": "svc-gateway.default.svc.cluster.local",
            "port": 8000,
        },
    }
